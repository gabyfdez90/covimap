...
function UnionRectVirus() {
    ...
    <div className='UnionRectVirusContainer'>
        ...
        <CasesConter theme="theme" label="Active Cases" numberTotal={data.active} />
        <CasesConter theme="theme" label="Recovered Cases" numberToday={`+${data.todayRecovered}`} numberTotal={data.recovered} />
        <CasesConter theme="theme" label="Death Cases" numberToday={`+${data.todayDeaths}`} numberTotal={data.deaths} />
    </div>
  )
}
