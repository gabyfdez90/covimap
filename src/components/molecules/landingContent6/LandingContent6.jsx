        ...
        <div className='molecula'>
            ...
            <div class="containerLanding6 ">
                    ...
                    <div class="col-6">
                        ...
                        <p><SlClock/> 9 Sept 2020 <spam><BiMessage id='icon'/> 21 Comment</spam><spam><Link style={{color:"white"}} to='/Continue'>Continue</Link></spam></p>
                        <h4>Can COVID-19 be caught from a person who has no symptoms?</h4>

                    </div>
                    <div class="col-6">
                        <img className='mascarilla'src={blog2} style={{ width: '20%' }} />
                        <p><SlClock/> 9 Sept 2020 <spam><BiMessage id='icon'/> 21 Comment</spam></p>
