        ...
        <div className="container">
            ...
            <p className="text"> These droplets can land on objects and surfaces around the person such as tables, doorknobs and handrails. </p>
                <span id='icons'>
                    ...
                    <BsFacebook className='facebook'color='#2d5db6bb'/></button>
                    <button className="btn2" onClick={() => console.log('Button clicked')}>
                    <AiFillTwitterCircle className='twitter' color='#2d5db6bb'/></button>
                    <button className="btn3" onClick={() => console.log('Button clicked')}>
                    <FaLinkedin className='faLinkedin' color='#2d5db6bb'/></button>
                    <button className="btn4" onClick={() => console.log('Button clicked')}>
                    <TiSocialYoutubeCircular className='youtube' color='#2d5db6bb'/></button>
                </span>
            </div>
            <div className="col" id='two' >
                <button className="btnQ" onClick={() => console.log('Button clicked')}>
                <p className="h4 ">Quic Links</p></button>
            ...
            <div className="col" id='three'>
                <button className="btnA" onClick={() => console.log('Button clicked')}>
                <p className="h4 ">About</p></button>
            ...
            <div className="col" id='five'>
                <button className="btnH" onClick={() => console.log('Button clicked')}>
                <p className="h4 ">Help</p></button>
                <p className="text">Hand Wash</p>
                <p className="text">Social distance</p>
                <p className="text">Isolate</p>
                <p className="text">Difference</p>
